...
const tldWrite = () => (
  <div className="tld13Container sectionMargin" id="tldWrite">
    <div className="tld13Feature">
      <Feature
        title="What is Meeting Summaraizer"
    ...
    <div className="tld13FeatureContainer">
      ...
      <Feature
        ...
        text="Meeting Summaraizer transcribes your conversations on the fly. TLDWrite will generate a transcript enriched with speaker identification and voice separation."
      />
    </div>
  </div>
);
